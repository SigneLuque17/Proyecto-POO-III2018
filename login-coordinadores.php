...
<body>
    ...
    <section>
        <p id="estudiante">INICIO DE SESIÓN COORDINADORES DE CARRERA</p>
        ...
        <form id="form1"> 
            <fieldset class="login">
                ...
                <hr>
                <button type="button" class="btn btn-warning" style="margin-left:35%" id="logCoor">Ingresar</button><br>
            </fieldset>
        </form>
        <div id="advertencia" >
